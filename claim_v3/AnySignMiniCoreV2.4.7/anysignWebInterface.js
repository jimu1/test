...
// document.write(
//   '<link href="./AnySignMiniCoreV2.4.7/css/canvas_css.css" rel="stylesheet">'
// );
// document.write(
//   '<link href="./AnySignMiniCoreV2.4.7/css/sp.css" rel="stylesheet">'
// );

// document.write(
//   '<link media="screen and (max-width: 480px)" href="./AnySignMiniCoreV2.4.7/css/mw480Portrait.css" rel="stylesheet">'
// );
// document.write(
//   '<link media="screen and (min-width: 480px) and (max-width: 1024px)" href="./AnySignMiniCoreV2.4.7/css/mw480Portrait.css" rel="stylesheet">'
// );
// document.write(
//   '<link media="screen and (min-width: 1024px)" href="./AnySignMiniCoreV2.4.7/css/sw1024.css" rel="stylesheet">'
// );

// document.write(
//   '<script language=javascript src="./AnySignMiniCoreV2.4.7/libs/zlib/deflate.min.js" charset="utf-8"></script>'
// );

// document.write(
//   '<script language=javascript src="./AnySignMiniCoreV2.4.7/libs/CryptoJS v3.1.2/components/core-min.js" charset="utf-8"></script>'
// );
// document.write(
//   '<script language=javascript src="./AnySignMiniCoreV2.4.7/libs/CryptoJS v3.1.2/rollups/sha1.js" charset="utf-8"></script>'
// );
// document.write(
//   '<script language=javascript src="./AnySignMiniCoreV2.4.7/libs/CryptoJS v3.1.2/rollups/tripledes.js" charset="utf-8"></script>'
// );
// document.write(
//   '<script language=javascript src="./AnySignMiniCoreV2.4.7/libs/CryptoJS v3.1.2/components/mode-ecb.js" charset="utf-8"></script>'
// );

// document.write(
//   '<script language=javascript src="./AnySignMiniCoreV2.4.7/libs/anysign_all.min.js" charset="utf-8"></script>'
// );
// document.write(
//   '<script language=javascript src="./AnySignMiniCoreV2.4.7/libs/anysignCommentUI.js" charset="utf-8"></script>'
// );
// // document.write("<script language=javascript src=\"libs/jquery-1.4.2.min.js\" charset=\"utf-8\"></script>");
// document.write(
//   '<script language=javascript src="./AnySignMiniCoreV2.4.7/libs/jquery-2.1.4.min.js" charset="utf-8"></script>'
// );
...
//  }
	...
	{
		return "AnySign_V1.3.3_Web_2.4.7";
	}
...
function SignatureConfig(signer, signRule)
{
    ...
    this.titleSpanToOffset = 4 + userName.length-1;//当为普通签名时有效，表示title中需要放大显示字体的数组结束index
